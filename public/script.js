...
// AI API配置 - 使用环境变量或默认值
const AI_CONFIG = {
    baseUrl: '/api/ai/analyze', // 使用本地API端点
    model: 'deepseek-ai/DeepSeek-V3.1',
    apiKey: 'client-side-token' // 客户端不需要真实API密钥
};
...
async function callAIForDataAnalysis() {
    ...
    console.log('📤 AI请求参数:', prompt);

    // 使用新的API封装函数
    const result = await callAI(prompt, selectedEmissionData, 'kanban');
